...
function cargar() {
    ...
    btn_limpiar.addEventListener("click", limpiarRegistrarItem, false);
    ...
    if (btnRegistrar) {
        btnRegistrar.addEventListener("click", function (e) {
            e.preventDefault();
            ajaxRegistrarItem(); // Lógica modular aparte
        }, false);
    }
}
